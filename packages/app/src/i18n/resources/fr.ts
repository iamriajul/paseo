...
export const fr: TranslationResources = {
  ...
  heartbeats: {
    ...
    pillPaused: "{{count}} en pause",
    pillNextRunAccessible: "{{count}} heartbeats, prochain {{when}}",
    pillPausedAccessible: "{{count}} heartbeats, en pause",
    statusPaused: "En pause",
    nextRun: "Prochain {{when}}",
    pauseAction: "Mettre en pause {{label}}",
    pauseTooltip: "Pause",
    pauseFailed: "Échec de la mise en pause du heartbeat",
    resumeAction: "Reprendre {{label}}",
    resumeTooltip: "Reprendre",
    resumeFailed: "Échec de la reprise du heartbeat",
    deleteAction: "Supprimer {{label}}",
    deleteTooltip: "Supprimer",
    deleteTitle: "Supprimer le heartbeat",
    deleteMessage: "Supprimer « {{label}} » ? Cette action est irréversible.",
    deleteConfirm: "Supprimer",
    deleteFailed: "Échec de la suppression du heartbeat",
    providerDetailTitle: "Heartbeat",
    detailPrompt: "Invite",
    detailMode: "Mode",
    detailSchedule: "Planification",
    detailNext: "Prochain",
    detailTaskId: "ID de tâche",
    noNextHint: "Inconnu",
  ...
  backgroundTasks: {
    ...
    pillCountAccessible: "{{count}} tâches d'arrière-plan",
    pillCountRunningAccessible: "{{count}} tâches d'arrière-plan, {{running}} en cours",
