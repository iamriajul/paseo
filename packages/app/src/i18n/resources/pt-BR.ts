...
export const ptBR: TranslationResources = {
  ...
  message: {
    diagram: {
      ...
      renderError: "Não foi possível renderizar o diagrama: {{message}}",
    },
    actions: {
  ...
  heartbeats: {
    ...
    pillPaused: "{{count}} pausados",
    pillNextRunAccessible: "{{count}} heartbeats, próximo {{when}}",
    pillPausedAccessible: "{{count}} heartbeats, pausados",
    statusPaused: "Pausado",
    nextRun: "Próximo {{when}}",
    pauseAction: "Pausar {{label}}",
    pauseTooltip: "Pausar",
    pauseFailed: "Falha ao pausar o heartbeat",
    resumeAction: "Retomar {{label}}",
    resumeTooltip: "Retomar",
    resumeFailed: "Falha ao retomar o heartbeat",
    deleteAction: "Excluir {{label}}",
    deleteTooltip: "Excluir",
    deleteTitle: "Excluir heartbeat",
    deleteMessage: 'Excluir "{{label}}"? Esta ação não pode ser desfeita.',
    deleteConfirm: "Excluir",
    deleteFailed: "Falha ao excluir o heartbeat",
    providerDetailTitle: "Heartbeat",
    detailPrompt: "Prompt",
    detailMode: "Modo",
    detailSchedule: "Agendamento",
    detailNext: "Próximo",
    detailTaskId: "ID da tarefa",
    noNextHint: "Desconhecido",
    modeRecurring: "Recorrente",
    modeOneShot: "Única vez",
    modeDynamic: "Dinâmico",
  },
  backgroundTasks: {
    ...
    pillCountAccessible: "{{count}} tarefas em segundo plano",
    pillCountRunningAccessible: "{{count}} tarefas em segundo plano, {{running}} em execução",
