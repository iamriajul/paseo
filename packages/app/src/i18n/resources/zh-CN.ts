...
export const zhCN: TranslationResources = {
  ...
  workspace: {
    ...
    browser: {
      ...
      iframeNotice:
        "此页面运行在 iframe 中，因此部分网站会拒绝加载，开发者工具也不可用。如需完整的浏览器，请使用桌面应用。",
      controls: {
        back: "后退",
        forward: "前进",
        stopLoading: "停止加载",
  ...
  heartbeats: {
    header: "心跳",
    headerCount: "心跳 ({{count}})",
    pillPaused: "{{count}} 个已暂停",
    pillNextRunAccessible: "{{count}} 个心跳，下次 {{when}}",
    pillPausedAccessible: "{{count}} 个心跳，已暂停",
    statusPaused: "已暂停",
    nextRun: "下次 {{when}}",
    pauseAction: "暂停 {{label}}",
    pauseTooltip: "暂停",
    pauseFailed: "暂停心跳失败",
    resumeAction: "恢复 {{label}}",
    resumeTooltip: "恢复",
    resumeFailed: "恢复心跳失败",
    deleteAction: "删除 {{label}}",
    deleteTooltip: "删除",
    deleteTitle: "删除心跳",
    deleteMessage: "删除“{{label}}”？此操作无法撤销。",
    deleteConfirm: "删除",
    deleteFailed: "删除心跳失败",
    providerDetailTitle: "心跳",
    detailPrompt: "提示词",
    detailMode: "模式",
    detailSchedule: "计划",
    detailNext: "下次",
  ...
  backgroundTasks: {
    ...
    pillCount: "{{count}} 个 Shell",
    pillCountAccessible: "{{count}} 个后台任务",
    pillCountRunningAccessible: "{{count}} 个后台任务，{{running}} 个运行中",
