...
export const ru: TranslationResources = {
  ...
  message: {
    diagram: {
      ...
      renderError: "Не удалось отобразить диаграмму: {{message}}",
    },
    actions: {
  ...
  workspace: {
    ...
    browser: {
      ...
      previewNotConfigured: {
        title: "Браузер не настроен на этом хосте",
        subtitle:
      ...
      iframeNotice:
        "Эта страница работает внутри iframe, поэтому некоторые сайты отказываются загружаться, а инструменты разработчика недоступны. Для полноценного браузера используйте настольное приложение.",
      controls: {
        back: "Назад",
        forward: "Вперед",
  ...
  heartbeats: {
    ...
    pillPaused: "{{count}} на паузе",
    pillNextRunAccessible: "Пульсаций: {{count}}, следующий {{when}}",
    pillPausedAccessible: "Пульсаций: {{count}}, на паузе",
  ...
  backgroundTasks: {
    ...
    pillCount: "Оболочек: {{count}}",
    pillCountAccessible: "Фоновых задач: {{count}}",
    pillCountRunningAccessible: "Фоновых задач: {{count}}, {{running}} выполняется",
