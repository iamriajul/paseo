...
function WorkspaceNewTabButton({
  ...
  const purpose = paneId === SIDE_PANEL_PANE_ID ? "supporting" : "primary";
  ...
  return (
    <View style={styles.inlineAddButton} onLayout={onLayout}>
      <DropdownMenu>
        ...
        <WorkspaceNewTabMenuContent serverId={serverId} purpose={purpose} paneId={paneId} />
      </DropdownMenu>
      {purpose === "primary" ? (
        <WorkspacePinnedTargetsRow serverId={serverId} purpose={purpose} paneId={paneId} />
      ) : null}
    </View>
  );
}
