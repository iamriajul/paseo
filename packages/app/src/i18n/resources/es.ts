...
export const es: TranslationResources = {
  ...
  message: {
    diagram: {
      ...
      renderError: "No se pudo renderizar el diagrama: {{message}}",
    },
    actions: {
  ...
  loops: {
    ...
    headerCountRunning: "Bucles ({{count}}) · {{running}} en ejecución",
  ...
  heartbeats: {
    ...
    pillPaused: "{{count}} en pausa",
    pillNextRunAccessible: "{{count}} heartbeats, próximo {{when}}",
    pillPausedAccessible: "{{count}} heartbeats, en pausa",
    statusPaused: "Pausado",
    nextRun: "Próximo {{when}}",
    pauseAction: "Pausar {{label}}",
    pauseTooltip: "Pausar",
    pauseFailed: "Error al pausar el heartbeat",
    resumeAction: "Reanudar {{label}}",
    resumeTooltip: "Reanudar",
    resumeFailed: "Error al reanudar el heartbeat",
    deleteAction: "Eliminar {{label}}",
    deleteTooltip: "Eliminar",
    deleteTitle: "Eliminar heartbeat",
    deleteMessage: '¿Eliminar "{{label}}"? Esta acción no se puede deshacer.',
    deleteConfirm: "Eliminar",
    deleteFailed: "Error al eliminar el heartbeat",
    providerDetailTitle: "Heartbeat",
    detailPrompt: "Prompt",
    detailMode: "Modo",
    detailSchedule: "Programación",
    detailNext: "Próximo",
    detailTaskId: "ID de tarea",
    noNextHint: "Desconocido",
  ...
  backgroundTasks: {
    ...
    pillCount: "{{count}} shells",
    pillCountAccessible: "{{count}} tareas en segundo plano",
    pillCountRunningAccessible: "{{count}} tareas en segundo plano, {{running}} en ejecución",
  ...
  todos: {
    ...
    headerCountDone: "Todos ({{count}}) · listos",
    itemOpenA11y: "Abierto: {{text}}",
    itemDoneA11y: "Hecho: {{text}}",
  },
  panels: {
    draft: {
      newAgent: "Nuevo agente",
    ...
    providers: {
      ...
      models: {
        ...
        autoCompactThresholdHint:
          "Cuándo Claude Code debe resumir el historial. Se aplica como CLAUDE_CODE_AUTO_COMPACT_WINDOW en sesiones compatibles con Claude.",
        autoCompactThresholdValue: "{{percent}}% · auto-compacta cerca de {{tokens}} tokens",
        autoCompactThresholdNeedsContext:
          "{{percent}}% · define una ventana de contexto para ver el umbral en tokens",
