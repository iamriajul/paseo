...
export const ar: TranslationResources = {
  ...
  message: {
    diagram: {
      ...
      renderError: "تعذّر عرض المخطط: {{message}}",
    },
    actions: {
      copyCode: "نسخ الرمز",
      copyTurn: "نسخ بدوره",
  ...
  workspace: {
    ...
    browser: {
      ...
      iframeNotice:
        "تعمل هذه الصفحة داخل إطار iframe، لذا ترفض بعض المواقع التحميل، كما أن أدوات التطوير غير متاحة. استخدم تطبيق سطح المكتب للحصول على متصفح كامل.",
      controls: {
        back: "خلف",
        forward: "إلى الأمام",
  ...
  heartbeats: {
    ...
    pillPaused: "{{count}} متوقفة مؤقتًا",
    pillNextRunAccessible: "{{count}} نبضات، التالي {{when}}",
    pillPausedAccessible: "{{count}} نبضات، متوقفة مؤقتًا",
    statusPaused: "متوقف مؤقتًا",
    nextRun: "التالي {{when}}",
    pauseAction: "إيقاف مؤقت {{label}}",
    pauseTooltip: "إيقاف مؤقت",
    pauseFailed: "فشل إيقاف heartbeat مؤقتًا",
    resumeAction: "استئناف {{label}}",
    resumeTooltip: "استئناف",
    resumeFailed: "فشل استئناف heartbeat",
    deleteAction: "حذف {{label}}",
    deleteTooltip: "حذف",
    deleteTitle: "حذف heartbeat",
    deleteMessage: 'حذف "{{label}}"؟ لا يمكن التراجع عن هذا الإجراء.',
    deleteConfirm: "حذف",
    deleteFailed: "فشل حذف heartbeat",
    providerDetailTitle: "Heartbeat",
    detailPrompt: "المطالبة",
    detailMode: "الوضع",
    detailSchedule: "الجدول",
    detailNext: "التالي",
    detailTaskId: "معرّف المهمة",
    noNextHint: "غير معروف",
    modeRecurring: "متكرر",
    modeOneShot: "مرة واحدة",
    modeDynamic: "ديناميكي",
  },
  backgroundTasks: {
    header: "Background Tasks",
    headerCount: "Background Tasks ({{count}})",
    headerCountRunning: "Background Tasks ({{count}}) · {{running}} running",
    pillCount: "{{count}} أصداف",
    pillCountAccessible: "{{count}} مهام خلفية",
    pillCountRunningAccessible: "{{count}} مهام خلفية، {{running}} قيد التشغيل",
