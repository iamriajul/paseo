...
const StoredAppSettingsSchema = z.strictObject({
  ...
  sidebarStatusSubtitle: z.enum(["host", "project"]).optional(),
  sidebarIdentityIcon: z.boolean().optional(),
  ...
  attentionIntrusiveMode: z.boolean().optional(),
  attentionOsBubbleEnabled: z.boolean().optional(),
  attentionSoundEnabled: z.boolean().optional(),
  /** May include legacy "classic" before the 10-sound expansion. */
  attentionSoundPreset: z.string().optional(),
